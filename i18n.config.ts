export default defineI18nConfig(() => ({
  ...
  messages: {
    en: {
      ...
      '@promo-slide$title': 'Every word matters',
      '@promo-slide$button': 'Let’s translate',
    ...
    lv: {
      ...
      '@service$3': 'Apliecinājums ar biroja zīmogu',
      '@service$4': 'Apostille',
      '@service$5': 'Legalizācija',
      '@services-slide$counter': 'Iztulkoti vārdi',
      '@promo-slide$title': 'Katram vārdam ir nozīme',
      '@promo-slide$button': 'Sākam tulkot',
