import { version, unref, inject, defineComponent, h, getCurrentInstance, defineAsyncComponent, computed, ref, provide, shallowReactive, watch, Suspense, nextTick, Fragment, Transition, hasInjectionContext, mergeProps, useSSRContext, createApp, effectScope, reactive, getCurrentScope, shallowRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, isRef, isReadonly, Text, withCtx, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, k as defu, l as sanitizeStatusCode, m as getContext, n as createHooks, e as createError$1, o as getRequestHeaders, p as toRouteMatcher, q as createRouter$1, r as klona, v as parse$1, w as getRequestHeader, d as destr, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index___en",
    path: "/en",
    component: () => import('./index-CmLQAKXA.mjs')
  },
  {
    name: "index___lv",
    path: "/",
...
const route_locale_detect_VrpP1JaYg8 = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(nuxt) {
    ...
    const localeChangeMiddleware = /* @__PURE__ */ defineNuxtRouteMiddleware(async (to, from) => {
      let __temp, __restore;
      const locale = ([__temp, __restore] = executeAsync(() => nuxtApp.runWithContext(() => handleRouteDetect(to))), __temp = await __temp, __restore(), __temp);
      const redirectPath = ([__temp, __restore] = executeAsync(() => nuxtApp.runWithContext(
        () => detectRedirect({ to, from, locale, routeLocale: getRouteLocale(to) }, true)
      )), __temp = await __temp, __restore(), __temp);
      nuxtApp._vueI18n.__firstAccess = false;
      return [__temp, __restore] = executeAsync(() => nuxtApp.runWithContext(() => navigate({ nuxtApp, redirectPath, locale, route: to }))), __temp = await __temp, __restore(), __temp;
    });
    ...
    extendI18n(i18n, {
      extendComposer(composer) {
        ...
        composer.finalizePendingLocaleChange = async () => {
          ...
          (_a = i18n.__resolvePendingLocalePromise) == null ? undefined : _a.call(i18n);
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BgZeJqjN.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-BWhP3wsk.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DYIiZsii.mjs'));
...
export { _export_sfc as _, useI18n as a, useRouter as b, navigateTo as c, useNuxtApp as d, entry$1 as default, useRuntimeConfig as e, withoutTrailingSlash as f, resolveUnrefHeadInput as g, hasProtocol as h, injectHead as i, joinURL as j, nuxtLinkDefaults as n, parseQuery as p, resolveRouteObject$1 as r, useSwitchLocalePath as u, withTrailingSlash as w };
